...
export function main(): void {
  ...
  section("1. Setup — Generate 5 maker keypairs");
  ...
  section("2. Taker generates ring signature");
  ...
  section("3. Maker (cash withdrawer) verifies the proof");
  ...
  section("4. Nullifier reuse detection (linkability)");
